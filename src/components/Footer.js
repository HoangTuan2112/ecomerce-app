...
import { BsSearch,BsGithub, BsLinkedin, BsFacebook, BsInstagram, BsYoutube } from "react-icons/bs";
    ...
    <>
      ...
      <footer className="py-4">
        ...
        <div className="col-4">
          ...
          <div>
            ...
            <div className="social-icons d-flex align-items-center gap-30">
             ...
             <a href="#"> <BsFacebook className="text-white fs-4 ms-3" /></a>
             <a href="#"> <BsInstagram className="text-white fs-4 ms-3" /></a>
             <a href="#"> <BsYoutube className="text-white fs-4 ms-3" /></a>
        ...
        <div className="col-3">
          ...
          <Link className="text-white py2 mb-1">Privacy Policy</Link>
          <Link className="text-white py2 mb-1">Refund Policy</Link>
          <Link className="text-white py2 mb-1">Shipping Policy</Link>
          <Link className="text-white py2 mb-1">Terms & Conditions</Link>
          <Link className="text-white py2 mb-1">Blogs</Link>
